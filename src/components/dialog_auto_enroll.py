...
def auto_enroll_dialog(subject_code):
    student_id = st.session_state.student_data['usn']
    ...
    check = supabase.table('subject_students').select('*').eq('subject_id', subject['subject_id']).ilike('usn', student_id).execute()
    if check.data:
